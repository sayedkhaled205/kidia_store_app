	...
	public static function element_definitions( string $page ): array {
		...
		$definitions = array(
			...
			'product' => array(
				...
				self::element( 'product_summary', __( 'Product Information', 'kidia-mobile-cms' ), 'dashicons-info-outline', array( self::field( 'show_name', __( 'Show product name', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'show_price', __( 'Show price', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'show_regular_price', __( 'Show regular price', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'show_rating', __( 'Show rating', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'show_review_count', __( 'Show review count', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'show_sku', __( 'Show SKU', 'kidia-mobile-cms' ), 'checkbox', false ), self::field( 'show_stock', __( 'Show stock', 'kidia-mobile-cms' ), 'checkbox', false ), self::field( 'show_badge', __( 'Show badge', 'kidia-mobile-cms' ), 'checkbox', false ), self::field( 'show_selected_color', __( 'Show selected color', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'price_color', __( 'Price color', 'kidia-mobile-cms' ), 'color', '#2F806E' ), self::field( 'name_color', __( 'Product name color', 'kidia-mobile-cms' ), 'color', '#1D1D1D' ), self::field( 'name_price_gap', __( 'Space between price and product name', 'kidia-mobile-cms' ), 'number', 20, array(), 0, 64 ), self::field( 'price_size', __( 'Price size', 'kidia-mobile-cms' ), 'number', 25, array(), 14, 36 ), self::field( 'name_size', __( 'Product name size', 'kidia-mobile-cms' ), 'number', 18, array(), 12, 28 ) ) ),
				self::element( 'variations', __( 'Variations', 'kidia-mobile-cms' ), 'dashicons-screenoptions', array( self::field( 'style', __( 'Selector style', 'kidia-mobile-cms' ), 'select', 'chips', array( 'chips' => __( 'Chips', 'kidia-mobile-cms' ), 'dropdown' => __( 'Dropdown', 'kidia-mobile-cms' ) ) ), self::field( 'show_size_chart', __( 'Show size chart link', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'size_chart_label', __( 'Size chart label', 'kidia-mobile-cms' ), 'text', __( 'Size chart', 'kidia-mobile-cms' ) ), self::field( 'title_color', __( 'Variation title color', 'kidia-mobile-cms' ), 'color', '#1D1D1D' ), self::field( 'option_text_color', __( 'Variation option text color', 'kidia-mobile-cms' ), 'color', '#1F2933' ), self::field( 'group_gap', __( 'Space between variations', 'kidia-mobile-cms' ), 'number', 18, array(), 0, 48 ), self::field( 'chip_radius', __( 'Option radius', 'kidia-mobile-cms' ), 'number', 22, array(), 0, 32 ), self::field( 'chip_height', __( 'Option height', 'kidia-mobile-cms' ), 'number', 44, array(), 32, 60 ) ) ),
