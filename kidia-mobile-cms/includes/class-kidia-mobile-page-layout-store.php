...
final class Kidia_Mobile_Page_Layout_Store {
	...
	public static function pages(): array {
		return array(
			...
			'size_chart' => __( 'Size Chart Page', 'kidia-mobile-cms' ),
	...
	public static function header_fields(): array {
		return array(
			...
			self::field( 'collapse_transition', __( 'Collapsed header transition', 'kidia-mobile-cms' ), 'select', 'smooth_compact', array( 'smooth_compact' => __( 'Smooth layout transition', 'kidia-mobile-cms' ), 'instant' => __( 'Instant (no animation)', 'kidia-mobile-cms' ), 'fade' => __( 'Fade in / out', 'kidia-mobile-cms' ), 'slide' => __( 'Slide up', 'kidia-mobile-cms' ), 'fade_slide' => __( 'Fade + slide', 'kidia-mobile-cms' ), 'scale' => __( 'Shrink / scale', 'kidia-mobile-cms' ) ) ),
			...
			self::field( 'row_2_position', __( 'Second row position', 'kidia-mobile-cms' ), 'select', 'center', array( 'up' => __( 'Up', 'kidia-mobile-cms' ), 'center' => __( 'Center', 'kidia-mobile-cms' ), 'down' => __( 'Down', 'kidia-mobile-cms' ) ) ),
			self::field( 'row_merge', __( 'Merge rows', 'kidia-mobile-cms' ), 'number', 0, array(), 0, 24 ),
			...
			self::field( 'title_font_size', __( 'Title font size', 'kidia-mobile-cms' ), 'number', 18, array(), 10, 42 ),
			self::field( 'title_font_weight', __( 'Title font weight', 'kidia-mobile-cms' ), 'select', '700', array( '400' => __( 'Regular', 'kidia-mobile-cms' ), '500' => __( 'Medium', 'kidia-mobile-cms' ), '600' => __( 'Semi bold', 'kidia-mobile-cms' ), '700' => __( 'Bold', 'kidia-mobile-cms' ), '800' => __( 'Extra bold', 'kidia-mobile-cms' ) ) ),
			self::field( 'title_alignment', __( 'Title text alignment', 'kidia-mobile-cms' ), 'select', 'center', array( 'start' => __( 'Start', 'kidia-mobile-cms' ), 'center' => __( 'Center', 'kidia-mobile-cms' ), 'end' => __( 'End', 'kidia-mobile-cms' ) ) ),
			self::field( 'title_max_width_percent', __( 'Title maximum width (%)', 'kidia-mobile-cms' ), 'number', 100, array(), 20, 100 ),
			self::field( 'title_letter_spacing', __( 'Title letter spacing', 'kidia-mobile-cms' ), 'number', 0, array(), -2, 8, 0.1 ),
			self::field( 'title_line_height', __( 'Title line height', 'kidia-mobile-cms' ), 'number', 1.2, array(), 0.8, 2, 0.05 ),
			self::field( 'title_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'title_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'title_transform', __( 'Title letter case', 'kidia-mobile-cms' ), 'select', 'none', array( 'none' => __( 'As entered', 'kidia-mobile-cms' ), 'uppercase' => __( 'Uppercase', 'kidia-mobile-cms' ), 'lowercase' => __( 'Lowercase', 'kidia-mobile-cms' ) ) ),
			self::field( 'logo_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'logo_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'search_icon_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'search_icon_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'search_bar_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'search_bar_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'back_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'back_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'cart_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'cart_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'wishlist_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'wishlist_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'account_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'account_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'orders_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'orders_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'support_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'support_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'menu_offset_x', __( 'Horizontal position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
			self::field( 'menu_offset_y', __( 'Vertical position', 'kidia-mobile-cms' ), 'number', 0, array(), -80, 80 ),
	...
	public static function element_definitions( string $page ): array {
		...
		$wishlist_message_fields = static function ( string $title, string $description, string $button_label, string $button_action ): array {
			return array(
				self::field( 'illustration_url', __( 'Illustration', 'kidia-mobile-cms' ), 'image', '' ),
				self::field( 'illustration_size', __( 'Illustration size', 'kidia-mobile-cms' ), 'number', 104, array(), 56, 180 ),
				self::field( 'top_spacing', __( 'Space above illustration', 'kidia-mobile-cms' ), 'number', 56, array(), 0, 180 ),
				self::field( 'title', __( 'Title', 'kidia-mobile-cms' ), 'text', $title ),
				self::field( 'title_size', __( 'Title size', 'kidia-mobile-cms' ), 'number', 18, array(), 12, 36 ),
				self::field( 'title_weight', __( 'Title weight', 'kidia-mobile-cms' ), 'select', '700', array( '400' => __( 'Regular', 'kidia-mobile-cms' ), '500' => __( 'Medium', 'kidia-mobile-cms' ), '600' => __( 'Semi bold', 'kidia-mobile-cms' ), '700' => __( 'Bold', 'kidia-mobile-cms' ), '800' => __( 'Extra bold', 'kidia-mobile-cms' ) ) ),
				self::field( 'description', __( 'Description', 'kidia-mobile-cms' ), 'text', $description ),
				self::field( 'show_description', __( 'Show description', 'kidia-mobile-cms' ), 'checkbox', '' !== $description ),
				self::field( 'description_size', __( 'Description size', 'kidia-mobile-cms' ), 'number', 14, array(), 11, 26 ),
				self::field( 'content_gap', __( 'Content spacing', 'kidia-mobile-cms' ), 'number', 16, array(), 0, 48 ),
				self::field( 'button_label', __( 'Button label', 'kidia-mobile-cms' ), 'text', $button_label ),
				self::field( 'button_action', __( 'Button action', 'kidia-mobile-cms' ), 'select', $button_action, array( 'shopping' => __( 'Continue shopping', 'kidia-mobile-cms' ), 'sign_in' => __( 'Sign in', 'kidia-mobile-cms' ) ) ),
				self::field( 'show_button', __( 'Show button', 'kidia-mobile-cms' ), 'checkbox', true ),
				self::field( 'button_width', __( 'Button width', 'kidia-mobile-cms' ), 'number', 220, array(), 120, 360 ),
				self::field( 'button_height', __( 'Button height', 'kidia-mobile-cms' ), 'number', 52, array(), 36, 84 ),
				self::field( 'button_radius', __( 'Button radius', 'kidia-mobile-cms' ), 'number', 26, array(), 0, 42 ),
				self::field( 'button_style', __( 'Button style', 'kidia-mobile-cms' ), 'select', 'outline', array( 'outline' => __( 'Outline', 'kidia-mobile-cms' ), 'filled' => __( 'Filled', 'kidia-mobile-cms' ) ) ),
				self::field( 'button_color', __( 'Button color', 'kidia-mobile-cms' ), 'color', '#FFFFFF' ),
				self::field( 'button_text_color', __( 'Button text color', 'kidia-mobile-cms' ), 'color', '#1D1D1D' ),
				self::field( 'button_border_color', __( 'Button border color', 'kidia-mobile-cms' ), 'color', '#1D1D1D' ),
				self::field( 'button_border_width', __( 'Button border width', 'kidia-mobile-cms' ), 'number', 1.5, array(), 0, 6, 0.5 ),
				self::field( 'bottom_spacing', __( 'Space below content', 'kidia-mobile-cms' ), 'number', 96, array(), 0, 220 ),
			);
		};
		$wishlist_recommendation_fields = array(
			self::field( 'title', __( 'Section title', 'kidia-mobile-cms' ), 'text', __( 'You may also like', 'kidia-mobile-cms' ) ),
			self::field( 'title_size', __( 'Title size', 'kidia-mobile-cms' ), 'number', 20, array(), 14, 36 ),
			self::field( 'title_weight', __( 'Title weight', 'kidia-mobile-cms' ), 'select', '700', array( '400' => __( 'Regular', 'kidia-mobile-cms' ), '500' => __( 'Medium', 'kidia-mobile-cms' ), '600' => __( 'Semi bold', 'kidia-mobile-cms' ), '700' => __( 'Bold', 'kidia-mobile-cms' ), '800' => __( 'Extra bold', 'kidia-mobile-cms' ) ) ),
			self::field( 'columns', __( 'Columns', 'kidia-mobile-cms' ), 'number', 2, array(), 1, 3 ),
			self::field( 'gap', __( 'Gap', 'kidia-mobile-cms' ), 'number', 8, array(), 0, 24 ),
			self::field( 'image_ratio', __( 'Image ratio', 'kidia-mobile-cms' ), 'number', 0.82, array(), 0.6, 1.8, 0.05 ),
			self::field( 'enable_image_swipe', __( 'Swipe product images on the card', 'kidia-mobile-cms' ), 'checkbox', false ),
			self::field( 'limit', __( 'Products count', 'kidia-mobile-cms' ), 'number', 4, array(), 2, 12 ),
			self::field( 'show_name', __( 'Show product name', 'kidia-mobile-cms' ), 'checkbox', false ),
			self::field( 'show_price', __( 'Show price', 'kidia-mobile-cms' ), 'checkbox', true ),
			self::field( 'show_quick_add', __( 'Show quick add', 'kidia-mobile-cms' ), 'checkbox', true ),
			self::field( 'layout_style', __( 'Product layout', 'kidia-mobile-cms' ), 'select', 'grid', array( 'grid' => __( 'Grid', 'kidia-mobile-cms' ), 'compact' => __( 'Compact grid', 'kidia-mobile-cms' ), 'carousel' => __( 'Horizontal carousel', 'kidia-mobile-cms' ) ) ),
			self::field( 'card_radius', __( 'Card radius', 'kidia-mobile-cms' ), 'number', 0, array(), 0, 32 ),
			self::field( 'card_background_color', __( 'Card background', 'kidia-mobile-cms' ), 'color', '#FFFFFF' ),
			self::field( 'action_type', __( 'Action type', 'kidia-mobile-cms' ), 'select', 'product', array( 'product' => __( 'Open product', 'kidia-mobile-cms' ), 'category' => __( 'Open category', 'kidia-mobile-cms' ), 'url' => __( 'Open URL', 'kidia-mobile-cms' ), 'none' => __( 'No action', 'kidia-mobile-cms' ) ) ),
			self::field( 'action_value', __( 'Action value', 'kidia-mobile-cms' ), 'text', '' ),
			self::field( 'section_padding', __( 'Side padding', 'kidia-mobile-cms' ), 'number', 16, array(), 0, 32 ),
			self::field( 'title_bottom_spacing', __( 'Space below title', 'kidia-mobile-cms' ), 'number', 18, array(), 0, 48 ),
		);
		...
		$definitions = array(
			...
			'product' => array(
				self::element( 'product_tabs', __( 'Product Tabs', 'kidia-mobile-cms' ), 'dashicons-index-card', array( self::field( 'sticky', __( 'Keep tabs visible while scrolling', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'tabs_json', __( 'Visible product tabs', 'kidia-mobile-cms' ), 'tabs', wp_json_encode( array( array( 'label' => __( 'Overview', 'kidia-mobile-cms' ), 'target' => 'overview', 'enabled' => true ), array( 'label' => __( 'Reviews', 'kidia-mobile-cms' ), 'target' => 'reviews', 'enabled' => true ), array( 'label' => __( 'Recommend', 'kidia-mobile-cms' ), 'target' => 'recommend', 'enabled' => true ) ) ) ), self::field( 'active_color', __( 'Active tab color', 'kidia-mobile-cms' ), 'color', '#1D1D1D' ), self::field( 'inactive_color', __( 'Inactive tab color', 'kidia-mobile-cms' ), 'color', '#6B6B6B' ), self::field( 'indicator_width', __( 'Indicator width', 'kidia-mobile-cms' ), 'number', 96, array(), 24, 160 ), self::field( 'height', __( 'Tabs height', 'kidia-mobile-cms' ), 'number', 64, array(), 44, 88 ) ) ),
				self::element( 'image_gallery', __( 'Product Gallery', 'kidia-mobile-cms' ), 'dashicons-format-gallery', array( self::field( 'aspect_ratio', __( 'Image ratio', 'kidia-mobile-cms' ), 'number', 0.75, array(), 0.6, 1.8, 0.05 ), self::field( 'fit', __( 'Image fit', 'kidia-mobile-cms' ), 'select', 'contain', array( 'contain' => __( 'Contain', 'kidia-mobile-cms' ), 'cover' => __( 'Cover', 'kidia-mobile-cms' ) ) ), self::field( 'background_color', __( 'Gallery background', 'kidia-mobile-cms' ), 'color', '#FFFFFF' ), self::field( 'show_thumbnails', __( 'Show thumbnails', 'kidia-mobile-cms' ), 'checkbox', false ), self::field( 'show_indicators', __( 'Show indicators', 'kidia-mobile-cms' ), 'checkbox', false ), self::field( 'show_counter', __( 'Show image counter', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'counter_background', __( 'Counter background', 'kidia-mobile-cms' ), 'color', '#8A8585' ), self::field( 'counter_text_color', __( 'Counter text color', 'kidia-mobile-cms' ), 'color', '#FFFFFF' ), self::field( 'enable_zoom', __( 'Enable zoom', 'kidia-mobile-cms' ), 'checkbox', false ) ) ),
				...
				self::element( 'related_products', __( 'Related Products', 'kidia-mobile-cms' ), 'dashicons-products', array( self::field( 'title', __( 'Section title', 'kidia-mobile-cms' ), 'text', __( 'You may also like', 'kidia-mobile-cms' ) ), self::field( 'columns', __( 'Columns', 'kidia-mobile-cms' ), 'number', 2, array(), 1, 3 ), self::field( 'gap', __( 'Gap', 'kidia-mobile-cms' ), 'number', 2, array(), 0, 24 ), self::field( 'image_ratio', __( 'Image ratio', 'kidia-mobile-cms' ), 'number', 0.75, array(), 0.6, 1.8, 0.05 ), self::field( 'enable_image_swipe', __( 'Swipe product images on the card', 'kidia-mobile-cms' ), 'checkbox', false ), self::field( 'show_price', __( 'Show price', 'kidia-mobile-cms' ), 'checkbox', true ), self::field( 'show_quick_add', __( 'Show quick add', 'kidia-mobile-cms' ), 'checkbox', true ) ) ),
			),
			'size_chart' => array(
				self::element( 'size_chart_content', __( 'Size Chart', 'kidia-mobile-cms' ), 'dashicons-editor-table', array(
					self::field( 'title', __( 'Page title', 'kidia-mobile-cms' ), 'text', __( 'Size chart', 'kidia-mobile-cms' ) ),
					self::field( 'description', __( 'Description', 'kidia-mobile-cms' ), 'text', __( 'Choose the size that fits you best.', 'kidia-mobile-cms' ) ),
					self::field( 'layout_style', __( 'Layout', 'kidia-mobile-cms' ), 'select', 'list', array( 'list' => __( 'List', 'kidia-mobile-cms' ), 'table' => __( 'Table', 'kidia-mobile-cms' ), 'chips' => __( 'Chips', 'kidia-mobile-cms' ) ) ),
					self::field( 'show_description', __( 'Show description', 'kidia-mobile-cms' ), 'checkbox', true ),
					self::field( 'row_height', __( 'Row height', 'kidia-mobile-cms' ), 'number', 52, array(), 36, 80 ),
					self::field( 'title_size', __( 'Title size', 'kidia-mobile-cms' ), 'number', 24, array(), 14, 40 ),
					self::field( 'row_color', __( 'Row background', 'kidia-mobile-cms' ), 'color', '#F6F8F7' ),
					self::field( 'text_color', __( 'Text color', 'kidia-mobile-cms' ), 'color', '#1F2933' ),
					self::field( 'accent_color', __( 'Selected color', 'kidia-mobile-cms' ), 'color', '#2F806E' )
				) ),
			),
			'wishlist' => array(
				self::element( 'sign_in_state', __( 'Sign-in Wishlist', 'kidia-mobile-cms' ), 'dashicons-lock', $wishlist_message_fields( __( 'Sign in to view your wishlist', 'kidia-mobile-cms' ), '', __( 'Sign In', 'kidia-mobile-cms' ), 'sign_in' ) ),
				self::element( 'sign_in_recommendations', __( 'Sign-in Recommendations', 'kidia-mobile-cms' ), 'dashicons-products', $wishlist_recommendation_fields ),
				self::element( 'empty_state', __( 'Empty Wishlist', 'kidia-mobile-cms' ), 'dashicons-heart', $wishlist_message_fields( __( 'Your wishlist is empty', 'kidia-mobile-cms' ), __( 'Add items here by clicking the little heart!', 'kidia-mobile-cms' ), __( 'Go Shopping', 'kidia-mobile-cms' ), 'shopping' ) ),
				self::element( 'empty_recommendations', __( 'Empty Wishlist Recommendations', 'kidia-mobile-cms' ), 'dashicons-products', $wishlist_recommendation_fields ),
				self::element( 'wishlist_grid', __( 'Wishlist Products', 'kidia-mobile-cms' ), 'dashicons-grid-view', $wishlist_grid ),
				self::element( 'products_recommendations', __( 'Wishlist Product Recommendations', 'kidia-mobile-cms' ), 'dashicons-products', $wishlist_recommendation_fields ),
			),
			'account' => array(
				...
				if ( 'product' === $page && 'product_tabs' === $type && (int) ( $saved['version'] ?? 1 ) < 20 ) {
					...
					if ( empty( $legacy_settings['tabs_json'] ) ) {
						$merged['settings']['tabs_json'] = wp_json_encode( array(
							array( 'label' => sanitize_text_field( (string) ( $legacy_settings['overview_label'] ?? __( 'Overview', 'kidia-mobile-cms' ) ) ), 'target' => 'overview', 'enabled' => true ),
							array( 'label' => sanitize_text_field( (string) ( $legacy_settings['reviews_label'] ?? __( 'Reviews', 'kidia-mobile-cms' ) ) ), 'target' => 'reviews', 'enabled' => true ),
							array( 'label' => sanitize_text_field( (string) ( $legacy_settings['recommend_label'] ?? __( 'Recommend', 'kidia-mobile-cms' ) ) ), 'target' => 'recommend', 'enabled' => true ),
						) );
					}
				}
				$merged['id'] = $id ?: $type;
