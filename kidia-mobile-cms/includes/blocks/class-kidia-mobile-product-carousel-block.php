...
final class Kidia_Mobile_Product_Carousel_Block extends Kidia_Mobile_Block {
	...
	<div class="kidia-builder-field kidia-builder-field--product-source">
		...
		<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add background size', 'kidia-mobile-cms' ); ?></label><input type="number" min="10" max="64" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_background_size]" value="<?php echo esc_attr( (string) $settings['quick_add_background_size'] ); ?>"></div>
