...
final class Kidia_Mobile_Banner_Grid_Block extends Kidia_Mobile_Block {
	...
	public function render_settings( int $index, array $settings ): void {
		...
		<div class="kidia-builder-grid">
			...
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Layout', 'kidia-mobile-cms' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][layout]"><option value="equal" <?php selected( 'equal', $settings['layout'] ); ?>><?php esc_html_e( 'Equal Grid', 'kidia-mobile-cms' ); ?></option><option value="featured" <?php selected( 'featured', $settings['layout'] ); ?>><?php esc_html_e( 'Featured First', 'kidia-mobile-cms' ); ?></option><option value="mosaic" <?php selected( 'mosaic', $settings['layout'] ); ?>><?php esc_html_e( 'Mosaic', 'kidia-mobile-cms' ); ?></option><option value="carousel" <?php selected( 'carousel', $settings['layout'] ); ?>><?php esc_html_e( 'Horizontal cards', 'kidia-mobile-cms' ); ?></option></select></div>
