...
final class Kidia_Mobile_Product_Grid_Block extends Kidia_Mobile_Block {
	...
	public function render_settings( int $index, array $settings ): void {
		...
		<div class="kidia-builder-grid">
			...
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Card Style', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][card_style]"><option value="outlined" <?php selected( 'outlined', $settings['card_style'] ); ?>><?php esc_html_e( 'Outlined', 'mobishop' ); ?></option><option value="elevated" <?php selected( 'elevated', $settings['card_style'] ); ?>><?php esc_html_e( 'Elevated', 'mobishop' ); ?></option><option value="minimal" <?php selected( 'minimal', $settings['card_style'] ); ?>><?php esc_html_e( 'Minimal', 'mobishop' ); ?></option><option value="no_shadow" <?php selected( 'no_shadow', $settings['card_style'] ); ?>><?php esc_html_e( 'No shadow', 'mobishop' ); ?></option></select></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Image Ratio', 'mobishop' ); ?></label><input type="number" min="0.6" max="1.8" step="0.1" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][image_ratio]" value="<?php echo esc_attr( (string) $settings['image_ratio'] ); ?>"></div>
			<div class="kidia-builder-field"><label><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][enable_image_swipe]" value="1" <?php checked( true, $settings['enable_image_swipe'] ); ?>> <?php esc_html_e( 'Swipe product images on the card', 'mobishop' ); ?></label></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Card Radius', 'mobishop' ); ?></label><input type="number" min="0" max="40" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][card_radius]" value="<?php echo esc_attr( (string) $settings['card_radius'] ); ?>"></div>
			...
			<?php endforeach; ?>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add icon shape', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_icon_variant]"><option value="bag" <?php selected( 'bag', $settings['quick_add_icon_variant'] ); ?>><?php esc_html_e( 'Shopping bag', 'mobishop' ); ?></option><option value="cart" <?php selected( 'cart', $settings['quick_add_icon_variant'] ); ?>><?php esc_html_e( 'Shopping cart', 'mobishop' ); ?></option><option value="basket" <?php selected( 'basket', $settings['quick_add_icon_variant'] ); ?>><?php esc_html_e( 'Shopping basket', 'mobishop' ); ?></option></select></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add icon style', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_icon_style]"><option value="outline" <?php selected( 'outline', $settings['quick_add_icon_style'] ); ?>><?php esc_html_e( 'Outline', 'mobishop' ); ?></option><option value="filled" <?php selected( 'filled', $settings['quick_add_icon_style'] ); ?>><?php esc_html_e( 'Filled', 'mobishop' ); ?></option><option value="rounded" <?php selected( 'rounded', $settings['quick_add_icon_style'] ); ?>><?php esc_html_e( 'Rounded', 'mobishop' ); ?></option></select></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add icon size', 'mobishop' ); ?></label><input type="number" min="10" max="36" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_icon_size]" value="<?php echo esc_attr( (string) $settings['quick_add_icon_size'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add icon color', 'mobishop' ); ?></label><input type="color" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_icon_color]" value="<?php echo esc_attr( $settings['quick_add_icon_color'] ); ?>"></div>
			<div class="kidia-builder-field"><label><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_show_background]" value="1" <?php checked( true, $settings['quick_add_show_background'] ); ?>> <?php esc_html_e( 'White background behind icon', 'mobishop' ); ?></label></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add background color', 'mobishop' ); ?></label><input type="color" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_background_color]" value="<?php echo esc_attr( $settings['quick_add_background_color'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add background size', 'mobishop' ); ?></label><input type="number" min="10" max="64" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_background_size]" value="<?php echo esc_attr( (string) $settings['quick_add_background_size'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add background radius', 'mobishop' ); ?></label><input type="number" min="0" max="40" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_radius]" value="<?php echo esc_attr( (string) $settings['quick_add_radius'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Quick add position', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][quick_add_position]"><?php foreach ( array( 'top_start' => 'Top start', 'top_end' => 'Top end', 'bottom_start' => 'Bottom start', 'bottom_end' => 'Bottom end' ) as $value => $label ) : ?><option value="<?php echo esc_attr( $value ); ?>" <?php selected( $value, $settings['quick_add_position'] ); ?>><?php echo esc_html( $label ); ?></option><?php endforeach; ?></select></div>
			<div class="kidia-builder-field"><label><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][show_wishlist]" value="1" <?php checked( true, $settings['show_wishlist'] ); ?>> <?php esc_html_e( 'Product wishlist icon', 'mobishop' ); ?></label></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist icon shape', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_icon_variant]"><option value="heart" <?php selected( 'heart', $settings['product_wishlist_icon_variant'] ); ?>>Heart</option><option value="rounded" <?php selected( 'rounded', $settings['product_wishlist_icon_variant'] ); ?>>Rounded heart</option><option value="bookmark" <?php selected( 'bookmark', $settings['product_wishlist_icon_variant'] ); ?>>Bookmark</option></select></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist icon style', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_icon_style]"><option value="outline" <?php selected( 'outline', $settings['product_wishlist_icon_style'] ); ?>>Outline</option><option value="filled" <?php selected( 'filled', $settings['product_wishlist_icon_style'] ); ?>>Filled</option></select></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist icon size', 'mobishop' ); ?></label><input type="number" min="10" max="36" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_icon_size]" value="<?php echo esc_attr( (string) $settings['product_wishlist_icon_size'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist icon color', 'mobishop' ); ?></label><input type="color" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_icon_color]" value="<?php echo esc_attr( $settings['product_wishlist_icon_color'] ); ?>"></div>
			<div class="kidia-builder-field"><label><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_show_background]" value="1" <?php checked( true, $settings['product_wishlist_show_background'] ); ?>> <?php esc_html_e( 'Product wishlist background', 'mobishop' ); ?></label></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist background color', 'mobishop' ); ?></label><input type="color" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_background_color]" value="<?php echo esc_attr( $settings['product_wishlist_background_color'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist background size', 'mobishop' ); ?></label><input type="number" min="20" max="64" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_background_size]" value="<?php echo esc_attr( (string) $settings['product_wishlist_background_size'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist background radius', 'mobishop' ); ?></label><input type="number" min="0" max="40" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_radius]" value="<?php echo esc_attr( (string) $settings['product_wishlist_radius'] ); ?>"></div>
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist position', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_position]"><?php foreach ( array( 'top_start' => 'Top start', 'top_end' => 'Top end', 'bottom_start' => 'Bottom start', 'bottom_end' => 'Bottom end' ) as $value => $label ) : ?><option value="<?php echo esc_attr( $value ); ?>" <?php selected( $value, $settings['product_wishlist_position'] ); ?>><?php echo esc_html( $label ); ?></option><?php endforeach; ?></select></div>
			<div class="kidia-builder-field kidia-builder-field--full">
