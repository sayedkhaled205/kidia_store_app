...
final class Kidia_Mobile_Product_Grid_Block extends Kidia_Mobile_Block {
	...
	public function sanitize_settings( array $settings ): array {
		...
		return array(
			...
			'product_wishlist_icon_size' => max( 16, min( 36, absint( $settings['product_wishlist_icon_size'] ?? 20 ) ) ),
	...
	public function render_settings( int $index, array $settings ): void {
		...
		<div class="kidia-builder-grid">
			...
			<div class="kidia-builder-field"><label><?php esc_html_e( 'Product wishlist icon size', 'kidia-mobile-cms' ); ?></label><input type="number" min="16" max="36" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][product_wishlist_icon_size]" value="<?php echo esc_attr( (string) $settings['product_wishlist_icon_size'] ); ?>"></div>
