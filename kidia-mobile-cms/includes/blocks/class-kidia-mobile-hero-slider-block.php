...
final class Kidia_Mobile_Hero_Slider_Block extends Kidia_Mobile_Block {
	...
	public function render_settings(
		...
		<div class="kidia-builder-grid">
			...
			<div class="kidia-builder-field kidia-slider-image-setting kidia-slider-image-setting--auto-play"><label><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][auto_play]" value="1" <?php checked( true, (bool) $settings['auto_play'] ); ?>> <?php echo esc_html__( 'Auto Play', 'mobishop' ); ?></label></div>
			<div class="kidia-builder-field kidia-slider-image-setting kidia-slider-image-setting--show-indicators"><label><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][show_indicators]" value="1" <?php checked( true, ! empty( $settings['show_indicators'] ) ); ?>> <?php esc_html_e( 'Show Indicators', 'mobishop' ); ?></label></div>
		</div>
		...
		<div class="kidia-hero-block-item kidia-slider-editor-item">
			<div class="kidia-hero-block-item__header">
				...
				<div class="kidia-repeatable-item-actions">
					<button type="button" class="button kidia-repeatable-remove kidia-remove-hero-block-item"><?php echo esc_html__( 'Remove', 'mobishop' ); ?></button>
					<button type="button" class="button kidia-repeatable-add kidia-add-hero-block-item"><?php echo esc_html__( '+ Add Slide', 'mobishop' ); ?></button>
					<label class="kidia-page-master-toggle kidia-slider-item-toggle" aria-label="<?php esc_attr_e( 'Turn slide on or off', 'mobishop' ); ?>">
