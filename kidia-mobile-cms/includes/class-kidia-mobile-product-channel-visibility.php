...
final class Kidia_Mobile_Product_Channel_Visibility {

	public const MOBILE_META  = '_kidia_hide_mobile';
	public const WEBSITE_META = '_kidia_hide_website';
	...
	private function is_mobile_request( ?WP_REST_Request $request = null ): bool {
		$channel = $request instanceof WP_REST_Request
			? sanitize_key( (string) $request->get_header( 'X-Kidia-Channel' ) )
			: sanitize_key( (string) ( $_SERVER['HTTP_X_KIDIA_CHANNEL'] ?? '' ) );
