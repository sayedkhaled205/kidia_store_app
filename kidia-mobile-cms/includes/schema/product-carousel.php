...
return array(
	...
	'fields' => array(
		...
		array( 'key' => 'enable_image_swipe', 'label' => __( 'Swipe product images on the card', 'kidia-mobile-cms' ), 'type' => 'checkbox', 'tab' => 'general', 'default' => false ),
		...
		array( 'key' => 'quick_add_icon_size', 'label' => __( 'Quick add icon size', 'kidia-mobile-cms' ), 'type' => 'number', 'tab' => 'general', 'default' => 22, 'min' => 10, 'max' => 36 ),
		...
		array( 'key' => 'product_wishlist_icon_size', 'label' => __( 'Product wishlist icon size', 'kidia-mobile-cms' ), 'type' => 'number', 'tab' => 'general', 'default' => 20, 'min' => 10, 'max' => 36 ),
		...
		array( 'key' => 'product_wishlist_background_size', 'label' => __( 'Product wishlist background size', 'kidia-mobile-cms' ), 'type' => 'number', 'tab' => 'general', 'default' => 40, 'min' => 20, 'max' => 64 ),
