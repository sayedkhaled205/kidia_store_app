...
final class Kidia_Mobile_Layout_Store {
	...
	public function get_kidia_patpat_layout(): array {
		...
		$names = array( 'Kidia Main Offer', 'Shop by Category', 'Kidia Benefits', 'Flash Sale', 'New Arrivals', 'Seasonal Collections', 'Best Sellers', 'Our Brands', 'More for Kids' );
		...
		foreach ( $types as $index => $type ) {
			...
			switch ( $type ) {
				...
				case 'category_grid':
					...
					break;
				case 'promo_strip':
					$block['settings']['text'] = __( 'New Kidia offers every day', 'mobishop' ); $block['settings']['background_color'] = '#EAF6F2'; $block['settings']['text_color'] = '#1F6F61';
					break;
				case 'countdown':
