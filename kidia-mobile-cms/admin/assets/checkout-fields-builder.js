(function () {
	...
	document.addEventListener("DOMContentLoaded", function () {
		const form = document.querySelector(".kidia-checkout-fields-form");
		...
		function syncCard(card) {
			...
			const options = card.querySelector(".kidia-checkout-options-field");
		...
		function bind(card) {
			...
			card.querySelector(".kidia-page-expand")?.addEventListener("click", function (event) {
				event.preventDefault();
				const body = card.querySelector(".kidia-page-card__body");
			...
			card.querySelector(".kidia-checkout-field-remove")?.addEventListener("click", function (event) {
				event.preventDefault();
				card.remove();
				reindex();
		...
		add.addEventListener("click", function () {
			...
			bind(card);
			reindex();
			card.querySelector(".kidia-page-expand")?.click();
