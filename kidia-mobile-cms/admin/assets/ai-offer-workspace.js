(function () {
	...
	const segmentStorageKey = 'kidia_ai_offer_segment_v1';
	...
	function initialize(root) {
		const pages = [];
		if (root && root.matches && root.matches('.kidia-ai-page')) pages.push(root);
		list(root || document, '.kidia-ai-page').forEach(function (page) {
