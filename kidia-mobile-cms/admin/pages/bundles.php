...
<div class="wrap kidia-ai-page kidia-bundles-page">
	...
	<section class="kidia-bundle-manager">
		...
		<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" data-kidia-bundle-form>
			...
			<div class="kidia-ai-bundle-grid">
				...
				<label class="kidia-ai-check"><input type="checkbox" name="bundle[allow_variants]" value="1" checked><span><?php esc_html_e( 'Customers may choose variants', 'mobishop' ); ?></span></label>
				<label class="kidia-ai-check"><input type="checkbox" name="bundle[allow_repeats]" value="1"><span><?php esc_html_e( 'Allow repeated products', 'mobishop' ); ?></span></label>
				<label class="kidia-ai-check"><input type="checkbox" name="bundle[coupon_stacking]" value="1"><span><?php esc_html_e( 'Allow coupon stacking', 'mobishop' ); ?></span></label>
				<label class="kidia-ai-check"><input type="checkbox" name="bundle[create_product]" value="1"><span><?php esc_html_e( 'Create a WooCommerce product for fixed bundles', 'mobishop' ); ?></span></label>
				<label>
			...
			<label class="kidia-ai-bundle-description"><span><?php esc_html_e( 'Customer-facing description', 'mobishop' ); ?></span><textarea name="bundle[description]" rows="3"></textarea></label>
	...
	<section class="kidia-saved-bundles">
		...
		<?php else : ?>
			<div class="kidia-ai-empty"><span class="dashicons dashicons-products"></span><div><strong><?php esc_html_e( 'No manual bundles yet', 'mobishop' ); ?></strong><p><?php esc_html_e( 'Create the first recipe with the form above.', 'mobishop' ); ?></p></div></div>
		<?php endif; ?>
	</section>
</div>
