...
<div class="wrap kidia-setup-wrap kidia-saved-themes-page">
	<div class="kidia-setup-hero">
		<div>
			<span class="kidia-setup-eyebrow"><?php esc_html_e( 'Reusable designs', 'mobishop' ); ?></span>
	...
	<section class="kidia-saved-themes">
		<?php if ( $saved_themes ) : ?>
			<div class="kidia-saved-themes__heading">
				...
				<form class="kidia-saved-themes__import-inline" method="post" enctype="multipart/form-data" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
					...
					<label class="kidia-theme-file"><input type="file" name="theme_file" accept="application/json,.json" required><span class="button"><?php esc_html_e( 'Choose theme file', 'mobishop' ); ?></span><b data-theme-file-name><?php esc_html_e( 'No file selected', 'mobishop' ); ?></b></label>
			...
			<dialog class="kidia-saved-theme-dialog" data-saved-theme-dialog aria-labelledby="kidia-saved-theme-dialog-title">
				<button type="button" class="kidia-saved-theme-dialog__close" data-saved-theme-dialog-close aria-label="<?php esc_attr_e( 'Close preview', 'mobishop' ); ?>">
					<span class="dashicons dashicons-no-alt" aria-hidden="true"></span>
				</button>
				<div class="kidia-saved-theme-dialog__content">
					<div class="kidia-saved-theme-dialog__intro">
						<span class="kidia-setup-eyebrow"><?php esc_html_e( 'Theme preview', 'mobishop' ); ?></span>
					...
					<nav class="kidia-saved-theme-dialog__pages" aria-label="<?php esc_attr_e( 'Theme pages', 'mobishop' ); ?>">
			...
			<dialog class="kidia-saved-theme-export-dialog" data-saved-theme-export-dialog aria-labelledby="kidia-saved-theme-export-title">
				<button type="button" class="kidia-saved-theme-export-dialog__close" data-saved-theme-export-close aria-label="<?php esc_attr_e( 'Close export options', 'mobishop' ); ?>">
					<span class="dashicons dashicons-no-alt" aria-hidden="true"></span>
				</button>
				<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" data-saved-theme-export-form>
					...
					<?php wp_nonce_field( 'kidia_mobile_manage_saved_theme', 'kidia_mobile_theme_nonce' ); ?>
					<span class="kidia-setup-eyebrow"><?php esc_html_e( 'Export theme', 'mobishop' ); ?></span>
					<h2 id="kidia-saved-theme-export-title"><?php esc_html_e( 'What do you want to export?', 'mobishop' ); ?></h2>
		...
		<?php else : ?>
			<div class="kidia-saved-themes__empty">
				...
				<p><?php esc_html_e( 'You do not have saved themes yet. Import a WooMobile theme file to start.', 'mobishop' ); ?></p>
