			...
			<?php if ( 'wishlist' === $page ) : ?>
				<section class="kidia-page-card is-open kidia-wishlist-access-mode">
					...
					<div class="kidia-page-card__body"><div class="kidia-category-navigation-modes">
						<label><input type="radio" name="layout[settings][wishlist_access_mode]" value="guest" <?php checked( (string) ( $layout['settings']['wishlist_access_mode'] ?? 'sign_in_required' ), 'guest' ); ?>><span><b><?php esc_html_e( 'Guest wishlist', 'kidia-mobile-cms' ); ?></b><small><?php esc_html_e( 'Allow adding products without signing in.', 'kidia-mobile-cms' ); ?></small><i class="dashicons dashicons-unlock"></i></span></label>
						<label><input type="radio" name="layout[settings][wishlist_access_mode]" value="sign_in_required" <?php checked( (string) ( $layout['settings']['wishlist_access_mode'] ?? 'sign_in_required' ), 'sign_in_required' ); ?>><span><b><?php esc_html_e( 'Sign in required', 'kidia-mobile-cms' ); ?></b><small><?php esc_html_e( 'Show the sign-in wishlist page for signed-out customers.', 'kidia-mobile-cms' ); ?></small><i class="dashicons dashicons-lock"></i></span></label>
					</div></div>
				</section>
			<?php endif; ?>
