...
$section_layout_keys = array( 'margin_top', 'margin_bottom', 'space_up', 'space_down', 'background_color' );
...
<section class="kidia-fixed-chrome-card kidia-page-card kidia-page-card--locked" data-element="<?php echo esc_attr( $chrome_part ); ?>" data-chrome-part="<?php echo esc_attr( $chrome_part ); ?>" data-page="<?php echo esc_attr( $chrome_page_name ); ?>">
	...
	<div class="kidia-page-card__body" hidden>
		...
		<section class="kidia-chrome-setting kidia-chrome-setting--section-layout"><div class="kidia-page-fields kidia-section-layout-component">
			<?php foreach ( $section_layout_keys as $layout_key ) { foreach ( $chrome_fields as $field ) { if ( $field['key'] === $layout_key ) { $render_chrome_field( $field, $chrome_settings[ $layout_key ] ?? $field['default'], $chrome_prefix . '[settings][' . $layout_key . ']' ); break; } } } ?>
		</div></section>
		</div>
	</div>
</section>
