					...
					<div class="kidia-page-card__body">
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								...
								<label><?php esc_html_e( 'Shadow strength', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="40" step="1" name="category_general[card_shadow_strength]" value="<?php echo esc_attr( (string) $category_general['card_shadow_strength'] ); ?>"></label>
								<label><?php esc_html_e( 'Shadow blur', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="40" step="1" name="category_general[card_shadow_blur]" value="<?php echo esc_attr( (string) $category_general['card_shadow_blur'] ); ?>"></label>
								...
								<div class="kidia-settings-section-title kidia-settings-section-title--section_layout"><?php esc_html_e( 'Section Layout Settings', 'kidia-mobile-cms' ); ?></div>
								<div class="kidia-section-layout-grid">
									<div class="kidia-section-layout-column kidia-section-layout-column--merge">
										<label><?php esc_html_e( 'Merge up', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[margin_top]" value="<?php echo esc_attr( (string) $category_general['margin_top'] ); ?>"></label>
										<label><?php esc_html_e( 'Merge down', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[margin_bottom]" value="<?php echo esc_attr( (string) $category_general['margin_bottom'] ); ?>"></label>
									</div>
									<div class="kidia-section-layout-column kidia-section-layout-column--space">
										<label><?php esc_html_e( 'Space up', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[space_up]" value="<?php echo esc_attr( (string) $category_general['space_up'] ); ?>"></label>
										<label><?php esc_html_e( 'Space down', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[space_down]" value="<?php echo esc_attr( (string) $category_general['space_down'] ); ?>"></label>
									</div>
									<div class="kidia-section-layout-column kidia-section-layout-column--background">
