			...
			<li class="kidia-category-row" data-term-id="<?php echo esc_attr( (string) $id ); ?>" data-default-name="<?php echo esc_attr( $term->name ); ?>" data-default-image="<?php echo esc_url( $default_image_url ); ?>">
				<div class="kidia-category-card">
					...
					<div class="kidia-category-image-actions">
						<button type="button" class="button button-secondary kidia-category-image-button<?php echo $image_id ? ' is-active' : ''; ?>" aria-pressed="<?php echo $image_id ? 'true' : 'false'; ?>"><?php esc_html_e( 'Change image', 'mobishop' ); ?></button>
						<button type="button" class="button button-secondary kidia-category-image-clear<?php echo $image_id ? '' : ' is-active'; ?>" aria-pressed="<?php echo $image_id ? 'false' : 'true'; ?>"><?php esc_html_e( 'Use WooCommerce image', 'mobishop' ); ?></button>
					</div>
					...
					<?php if ( $has_children ) : ?>
						<button type="button" class="button kidia-category-expand" aria-expanded="false" aria-label="<?php esc_attr_e( 'Expand subcategories', 'mobishop' ); ?>"><span class="dashicons dashicons-arrow-down-alt2"></span></button>
...
<div class="wrap kidia-category-builder">
	...
	<div class="kidia-category-workspace">
		<aside class="kidia-category-mobile-preview" aria-label="<?php echo esc_attr__( 'Live category preview', 'mobishop' ); ?>">
			<div class="kidia-category-phone">
				...
				<?php if ( file_exists( KIDIA_MOBILE_CMS_PATH . 'admin/flutter-preview/index.html' ) ) : ?>
					<iframe id="kidia-flutter-preview" class="kidia-flutter-preview" title="<?php echo esc_attr__( 'Flutter mobile preview', 'mobishop' ); ?>" src="<?php echo esc_url( add_query_arg( array( 'page' => 'category', 'v' => KIDIA_MOBILE_CMS_VERSION ), KIDIA_MOBILE_CMS_URL . 'admin/flutter-preview/index.html' ) ); ?>"></iframe>
			...
			<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<section class="kidia-page-card kidia-category-element" data-element="category">
					<div class="kidia-page-card__header">
						<div class="kidia-page-card__identity"><span class="dashicons dashicons-category"></span><strong><?php esc_html_e( 'Category', 'mobishop' ); ?></strong><small><?php esc_html_e( 'All category and subcategory content', 'mobishop' ); ?></small></div>
					...
					<div class="kidia-page-card__body" hidden>
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								<div class="kidia-settings-section-title"><?php esc_html_e( 'Layout & Spacing', 'mobishop' ); ?></div>
								...
								<label class="kidia-category-toggle-field"><b><?php esc_html_e( 'Show arrow', 'mobishop' ); ?></b><span class="kidia-page-master-toggle"><input type="hidden" name="category_general[show_arrow]" value="0"><input type="checkbox" name="category_general[show_arrow]" value="1" <?php checked( ! empty( $category_general['show_arrow'] ) ); ?>><span class="kidia-toggle-state"></span></span></label>
								...
								<div class="kidia-settings-section-title"><?php esc_html_e( 'Colors & Appearance', 'mobishop' ); ?></div>
								...
								<div class="kidia-settings-section-title"><?php esc_html_e( 'Image size & shape', 'mobishop' ); ?></div>
								...
								<div class="kidia-settings-section-title"><?php esc_html_e( 'Text and spacing', 'mobishop' ); ?></div>
						...
						<section class="kidia-category-items" data-navigation-mode="<?php echo esc_attr( $category_general['navigation_mode'] ); ?>" data-category-layout="<?php echo esc_attr( $category_general['category_layout'] ); ?>">
							<div class="kidia-category-items__heading"><h3><?php esc_html_e( 'Categories & Subcategories', 'mobishop' ); ?></h3><p><?php esc_html_e( 'Drag to reorder. Each row only changes its app name, app image and visibility.', 'mobishop' ); ?></p></div>
