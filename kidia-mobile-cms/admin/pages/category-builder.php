					...
					<div class="kidia-page-card__body">
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								...
								<label class="kidia-section-layout-field"><?php esc_html_e( 'Merge up', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[margin_top]" value="<?php echo esc_attr( (string) $category_general['margin_top'] ); ?>"></label>
								<label class="kidia-section-layout-field"><?php esc_html_e( 'Merge down', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[margin_bottom]" value="<?php echo esc_attr( (string) $category_general['margin_bottom'] ); ?>"></label>
								<label class="kidia-section-layout-field"><?php esc_html_e( 'Space up', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[space_up]" value="<?php echo esc_attr( (string) $category_general['space_up'] ); ?>"></label>
								<label class="kidia-section-layout-field"><?php esc_html_e( 'Space down', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" step="1" name="category_general[space_down]" value="<?php echo esc_attr( (string) $category_general['space_down'] ); ?>"></label>
								<label class="kidia-section-layout-field"><?php esc_html_e( 'Background color', 'kidia-mobile-cms' ); ?><input type="color" name="category_general[element_background_color]" value="<?php echo esc_attr( $category_general['element_background_color'] ); ?>"></label>
							</div>
						</section>
