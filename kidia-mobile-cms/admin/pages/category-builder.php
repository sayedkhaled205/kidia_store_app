					...
					<div class="kidia-page-card__body" hidden>
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								...
								<label><?php esc_html_e( 'Open categories', 'kidia-mobile-cms' ); ?><select name="category_general[navigation_mode]">
									<option value="expand_inline" <?php selected( $category_general['navigation_mode'], 'expand_inline' ); ?>><?php esc_html_e( 'Expand in the same page', 'kidia-mobile-cms' ); ?></option>
									<option value="separate_page" <?php selected( $category_general['navigation_mode'], 'separate_page' ); ?>><?php esc_html_e( 'Open in a new page', 'kidia-mobile-cms' ); ?></option>
								</select></label>
								...
								<label><?php esc_html_e( 'Card height (0 = automatic)', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="320" step="4" name="category_general[card_height]" value="<?php echo esc_attr( (string) $category_general['card_height'] ); ?>"></label>
								<label><?php esc_html_e( 'Card radius', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="32" step="1" name="category_general[card_radius]" value="<?php echo esc_attr( (string) $category_general['card_radius'] ); ?>"></label>
								<label><?php esc_html_e( 'Card spacing', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="24" step="1" name="category_general[card_gap]" value="<?php echo esc_attr( (string) $category_general['card_gap'] ); ?>"></label>
								<label><?php esc_html_e( 'Card width', 'kidia-mobile-cms' ); ?><input type="number" min="40" max="100" step="1" name="category_general[card_width_percent]" value="<?php echo esc_attr( (string) $category_general['card_width_percent'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Merge up', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" name="category_general[margin_top]" value="<?php echo esc_attr( (string) $category_general['margin_top'] ); ?>"></label>
								<label><?php esc_html_e( 'Merge down', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" name="category_general[margin_bottom]" value="<?php echo esc_attr( (string) $category_general['margin_bottom'] ); ?>"></label>
								<label><?php esc_html_e( 'Space up', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" name="category_general[space_up]" value="<?php echo esc_attr( (string) $category_general['space_up'] ); ?>"></label>
								<label><?php esc_html_e( 'Space down', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="80" name="category_general[space_down]" value="<?php echo esc_attr( (string) $category_general['space_down'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Shadow strength', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="40" name="category_general[card_shadow_strength]" value="<?php echo esc_attr( (string) $category_general['card_shadow_strength'] ); ?>"></label>
								<label><?php esc_html_e( 'Shadow blur', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="40" name="category_general[card_shadow_blur]" value="<?php echo esc_attr( (string) $category_general['card_shadow_blur'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Size', 'kidia-mobile-cms' ); ?><input type="number" min="32" max="120" step="4" name="category_general[image_size]" value="<?php echo esc_attr( (string) $category_general['image_size'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Round amount', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="50" step="1" name="category_general[image_radius]" value="<?php echo esc_attr( (string) $category_general['image_radius'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Zoom', 'kidia-mobile-cms' ); ?><input type="number" min="80" max="150" step="5" name="category_general[image_scale]" value="<?php echo esc_attr( (string) $category_general['image_scale'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Image–text gap', 'kidia-mobile-cms' ); ?><input type="number" min="0" max="40" step="1" name="category_general[image_text_gap]" value="<?php echo esc_attr( (string) $category_general['image_text_gap'] ); ?>"></label>
								<label><?php esc_html_e( 'Font size', 'kidia-mobile-cms' ); ?><input type="number" min="10" max="30" step="1" name="category_general[font_size]" value="<?php echo esc_attr( (string) $category_general['font_size'] ); ?>"></label>
								...
								<label><?php esc_html_e( 'Line height', 'kidia-mobile-cms' ); ?><input type="number" min="100" max="200" step="5" name="category_general[line_height]" value="<?php echo esc_attr( (string) $category_general['line_height'] ); ?>"></label>
							</div>
						</section>
