					...
					<div class="kidia-page-card__body">
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								<div class="kidia-settings-section-title"><?php esc_html_e( 'Category Layout', 'kidia-mobile-cms' ); ?></div>
								...
								<label><?php esc_html_e( 'Margin top', 'kidia-mobile-cms' ); ?><span class="kidia-range-value"><?php echo esc_html( (string) $category_general['margin_top'] ); ?>px</span><input type="range" min="0" max="80" name="category_general[margin_top]" value="<?php echo esc_attr( (string) $category_general['margin_top'] ); ?>"></label>
								<label><?php esc_html_e( 'Margin bottom', 'kidia-mobile-cms' ); ?><span class="kidia-range-value"><?php echo esc_html( (string) $category_general['margin_bottom'] ); ?>px</span><input type="range" min="0" max="80" name="category_general[margin_bottom]" value="<?php echo esc_attr( (string) $category_general['margin_bottom'] ); ?>"></label>
