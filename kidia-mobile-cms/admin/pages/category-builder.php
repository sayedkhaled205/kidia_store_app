					...
					<div class="kidia-page-card__body">
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								...
								<label><?php esc_html_e( 'Element background', 'kidia-mobile-cms' ); ?><input type="color" name="category_general[element_background_color]" value="<?php echo esc_attr( $category_general['element_background_color'] ); ?>"></label>
