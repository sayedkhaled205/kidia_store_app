					...
					<div class="kidia-page-card__body">
						<section class="kidia-category-general">
							...
							<div class="kidia-category-general-fields">
								...
								<label class="kidia-page-master-toggle"><input type="hidden" name="category_general[show_arrow]" value="0"><input type="checkbox" name="category_general[show_arrow]" value="1" <?php checked( ! empty( $category_general['show_arrow'] ) ); ?>><span class="kidia-toggle-state"></span><b><?php esc_html_e( 'Show arrow', 'kidia-mobile-cms' ); ?></b></label>
								...
								<label><?php esc_html_e( 'Background', 'kidia-mobile-cms' ); ?><input type="color" name="category_general[background_color]" value="<?php echo esc_attr( $category_general['background_color'] ); ?>"></label>
