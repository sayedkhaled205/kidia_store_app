	...
	<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" class="kidia-setup-form">
		...
		<section class="kidia-setup-step is-active" data-step="1" data-step-kind="identity">
			<div class="kidia-setup-step-heading">
				...
				<div><h2><?php esc_html_e( 'General Settings', 'kidia-mobile-cms' ); ?></h2><p><?php esc_html_e( 'Name, logo, language and brand colors are detected from the connected site and remain editable, alongside icon appearance and typography.', 'kidia-mobile-cms' ); ?></p></div>
			</div>
			<div class="kidia-setup-identity-grid">
				...
				<label><span><?php esc_html_e( 'Application icon shape', 'kidia-mobile-cms' ); ?></span><select name="setup[app_icon_shape]"><option value="rounded_square" <?php selected( 'rounded_square', $identity['app_icon_shape'] ?? 'rounded_square' ); ?>><?php esc_html_e( 'Rounded square', 'kidia-mobile-cms' ); ?></option><option value="circle" <?php selected( 'circle', $identity['app_icon_shape'] ?? '' ); ?>><?php esc_html_e( 'Circle', 'kidia-mobile-cms' ); ?></option><option value="square" <?php selected( 'square', $identity['app_icon_shape'] ?? '' ); ?>><?php esc_html_e( 'Square', 'kidia-mobile-cms' ); ?></option></select></label>
				<label class="kidia-setup-font-field"><span><?php esc_html_e( 'Font collection', 'kidia-mobile-cms' ); ?></span><select name="setup[font_family]"><optgroup label="<?php esc_attr_e( 'Recommended', 'kidia-mobile-cms' ); ?>"><option value="system" <?php selected( 'system', $identity['font_family'] ?? 'system' ); ?>><?php esc_html_e( 'System font', 'kidia-mobile-cms' ); ?></option><option value="poppins" <?php selected( 'poppins', $identity['font_family'] ?? '' ); ?>>Poppins</option><option value="roboto" <?php selected( 'roboto', $identity['font_family'] ?? '' ); ?>>Roboto</option><option value="noto_sans_arabic" <?php selected( 'noto_sans_arabic', $identity['font_family'] ?? '' ); ?>>Noto Sans Arabic</option></optgroup><optgroup label="<?php esc_attr_e( 'Classic', 'kidia-mobile-cms' ); ?>"><option value="serif" <?php selected( 'serif', $identity['font_family'] ?? '' ); ?>>Serif</option><option value="monospace" <?php selected( 'monospace', $identity['font_family'] ?? '' ); ?>>Monospace</option></optgroup></select></label>
