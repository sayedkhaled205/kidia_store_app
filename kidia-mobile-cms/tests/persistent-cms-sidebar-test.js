...
setTimeout(() => {
  ...
  setTimeout(() => {
    ...
    assert.deepEqual(requestedVersions, ["1.45.58", "1.45.58"], "Every navigation request must carry the running asset version.");
      ...
      json: async () => ({
        ...
        data: {
          ...
          styles: [{
            ...
            src: "https://store.test/wp-content/plugins/kidia-mobile-cms/admin/assets/cms-shell.css?ver=1.45.58-new"
          }],
          scripts: []
        }
      })
