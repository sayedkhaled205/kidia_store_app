...
kidia_assert( array( 'image_banner', 'category_grid' ) === array_column( array_slice( $default_layout, 0, 2 ), 'type' ), 'Fresh Home Pages must open with the banner followed by categories.' );
