...
test("Builder workspace fixes navigation, toolbar, and phone while only cards scroll", () => {
  ...
  assert.match(shellStyles, /body\.kidia-cms-builder-screen #wpcontent\{[^}]*overflow:hidden!important/);
  assert.match(shellStyles, /body\.kidia-cms-builder-screen #wpbody\{[^}]*overflow-y:scroll!important[^}]*scrollbar-gutter:stable/);
