...
function runMergeControlsContractTest() {
  ...
  const settingsSections = readAsset("settings-sections.js");
	...
	assert.match(heroBlockSource, /kidia-remove-hero-block-item[\s\S]*kidia-add-hero-block-item[\s\S]*kidia-repeatable-item-toggle/, "Slide actions must render Remove, Add Slide and Show together in that order.");
