...
assert.match(plugin, /Version:\s+1\.45\.71/, "The plugin header must be version 1.45.71.");
assert.match(
  plugin,
  /KIDIA_MOBILE_CMS_VERSION',\s*'1\.45\.71'/,
  "The runtime plugin version must match the 1.45.71 header."
);
assert.match(
  plugin,
