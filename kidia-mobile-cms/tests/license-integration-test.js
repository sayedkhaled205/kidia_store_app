...
assert.match(plugin, /Version:\s+1\.45\.81/, "The plugin header must be version 1.45.81.");
assert.match(
  plugin,
  /KIDIA_MOBILE_CMS_VERSION',\s*'1\.45\.81'/,
  "The runtime plugin version must match the 1.45.81 plugin header."
);
assert.match(
  plugin,
