...
assert.match(plugin, /Version:\s+1\.45\.61/, "The plugin header must be version 1.45.61.");
assert.match(
  plugin,
  /KIDIA_MOBILE_CMS_VERSION',\s*'1\.45\.61'/,
  "The runtime plugin version must match the 1.45.61 header."
);
assert.match(
  plugin,
