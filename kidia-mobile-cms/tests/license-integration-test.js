...
assert.match(plugin, /Version:\s+1\.45\.84/, "The plugin header must be version 1.45.84.");
assert.match(
  plugin,
  /KIDIA_MOBILE_CMS_VERSION',\s*'1\.45\.84'/,
  "The runtime plugin version must match the 1.45.84 plugin header."
);
assert.match(
  plugin,
