...
assert.match(service, /Setup themes use flat headers[\s\S]*\['shadow'\]\s*=\s*'none'/, "Every setup-theme header must stay flat and blend into the page without a shadow.");
