...
assert.match(shellCss, /body\.kidia-cms-plugin-page #adminmenuwrap\{[^}]*overflow-y:scroll!important;[^}]*direction:rtl;/, "The WordPress menu scrollbar must sit on the physical left side of the menu.");
