...
assert.match(dashboardTemplate, /data-build-modal[\s\S]*role="dialog"[\s\S]*data-build-message[\s\S]*data-build-progress[\s\S]*data-build-cancel/, "Starting a build must open one progress dialog with its cancel action.");
