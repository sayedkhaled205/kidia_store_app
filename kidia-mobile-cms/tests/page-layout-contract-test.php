...
$wishlist_empty_index = array_search( 'empty_state', $wishlist_ids, true );
$wishlist_empty = $wishlist_default['elements'][ $wishlist_empty_index ];
kidia_page_assert( true === $wishlist_grid['settings']['quick_add_enabled'], 'Wishlist Products quick add must default to enabled.' );
kidia_page_assert( 'shopping' === $wishlist_empty['settings']['button_action'], 'Empty Wishlist button must preserve Continue shopping as its default action.' );
$wishlist_custom = $wishlist_default;
$wishlist_custom['elements'][ $wishlist_empty_index ]['settings']['button_action'] = 'sign_in';
...
kidia_page_assert( 'smooth_compact' === $home_default['header']['settings']['collapse_transition'], 'Home must default to the smooth layout transition.' );
kidia_page_assert( 84 === $home_default['header']['settings']['compact_search_width_percent'], 'The transition Search must default below full width.' );
...
foreach ( array( 'collapse_transition', 'compact_search_width_percent', 'collapse_speed', 'compact_style', 'compact_background_color', 'compact_side_margin', 'compact_radius', 'compact_border_width', 'compact_border_color', 'compact_shadow' ) as $compact_setting ) {
