...
const dom = new JSDOM(
  ...
  </body>`,
  {
    ...
    url: "https://example.com/wp-admin/admin.php?page=kidia-mobile-cms&view=store-data",
  },
);
...
const firstFilter = window.document.querySelector(".kidia-date-filter");
...
replacement.className = "kidia-date-filter";
