...
if ( class_exists( 'MobiShop_Image_Banner_Block', false ) ) {
	return;
}

final class MobiShop_Image_Banner_Block extends MobiShop_Block {
		...
		<div class="mobishop-builder-grid">
			<div class="mobishop-builder-field mobishop-builder-field--full mobishop-builder-field--media">
				...
				<div class="mobishop-builder-media-field">
					<input
						type="url"
						class="mobishop-banner-image-url"
					...
					<button
						type="button"
						class="button mobishop-select-banner-image"
					>
						<?php
						echo esc_html__(
				...
				<img
					class="mobishop-banner-image-preview"
			...
			<div class="mobishop-builder-field"><label><?php esc_html_e( 'Overlay Title', 'mobishop' ); ?></label><input type="text" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][title]" value="<?php echo esc_attr( (string) $settings['title'] ); ?>"></div>
			<div class="mobishop-builder-field"><label><?php esc_html_e( 'Overlay Subtitle', 'mobishop' ); ?></label><input type="text" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][subtitle]" value="<?php echo esc_attr( (string) $settings['subtitle'] ); ?>"></div>
			<div class="mobishop-builder-field"><label><?php esc_html_e( 'Button Label', 'mobishop' ); ?></label><input type="text" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][button_label]" value="<?php echo esc_attr( (string) $settings['button_label'] ); ?>"></div>
			...
			<div class="mobishop-builder-field"><label><?php esc_html_e( 'Overlay Strength %', 'mobishop' ); ?></label><input type="number" min="0" max="95" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][overlay_strength]" value="<?php echo esc_attr( (string) $settings['overlay_strength'] ); ?>"></div>
