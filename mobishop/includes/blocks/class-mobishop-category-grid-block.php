...
if ( class_exists( 'MobiShop_Category_Grid_Block', false ) ) {
	return;
}

final class MobiShop_Category_Grid_Block extends MobiShop_Block {
	...
	public function get_label(): string {
		return __( 'Category Grid', 'mobishop' );
	}
	...
	public function get_description(): string {
		return __( 'WooCommerce categories in a mobile grid.', 'mobishop' );
	}
	...
	public function render_settings( int $index, array $settings ): void {
		...
		<div class="mobishop-builder-grid">
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--title">
			...
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--subtitle">
			...
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--category-ids"><label><?php esc_html_e( 'Manual Category IDs (optional)', 'mobishop' ); ?></label><input type="text" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][category_ids]" value="<?php echo esc_attr( (string) $settings['category_ids'] ); ?>" placeholder="12, 34, 56"></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--layout"><label><?php esc_html_e( 'Layout', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][layout]"><option value="grid" <?php selected( 'grid', $settings['layout'] ); ?>><?php esc_html_e( 'Classic grid', 'mobishop' ); ?></option><option value="compact" <?php selected( 'compact', $settings['layout'] ); ?>><?php esc_html_e( 'Compact grid', 'mobishop' ); ?></option><option value="cards" <?php selected( 'cards', $settings['layout'] ); ?>><?php esc_html_e( 'Rounded cards', 'mobishop' ); ?></option><option value="carousel" <?php selected( 'carousel', $settings['layout'] ); ?>><?php esc_html_e( 'Horizontal row', 'mobishop' ); ?></option><option value="editorial_mosaic" <?php selected( 'editorial_mosaic', $settings['layout'] ); ?>><?php esc_html_e( 'Editorial Mosaic', 'mobishop' ); ?></option><option value="full_width_banners" <?php selected( 'full_width_banners', $settings['layout'] ); ?>><?php esc_html_e( 'Full-width Banners', 'mobishop' ); ?></option></select></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--items-alignment"><label><?php esc_html_e( 'Items Alignment', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][items_alignment]"><option value="right" <?php selected( 'right', $settings['items_alignment'] ); ?>><?php esc_html_e( 'Right', 'mobishop' ); ?></option><option value="center" <?php selected( 'center', $settings['items_alignment'] ); ?>><?php esc_html_e( 'Center', 'mobishop' ); ?></option><option value="left" <?php selected( 'left', $settings['items_alignment'] ); ?>><?php esc_html_e( 'Left', 'mobishop' ); ?></option></select></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--limit">
				<label><?php esc_html_e( 'Categories Limit', 'mobishop' ); ?></label>
			...
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--columns">
			...
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--gap"><label><?php esc_html_e( 'Column Gap', 'mobishop' ); ?></label><input type="number" min="0" max="32" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][gap]" value="<?php echo esc_attr( (string) $settings['gap'] ); ?>"></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--row-gap"><label><?php esc_html_e( 'Row Gap', 'mobishop' ); ?></label><input type="number" min="0" max="80" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][row_gap]" value="<?php echo esc_attr( (string) $settings['row_gap'] ); ?>"></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--image-size"><label><?php esc_html_e( 'Image Size', 'mobishop' ); ?></label><input type="number" min="48" max="140" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][image_size]" value="<?php echo esc_attr( (string) $settings['image_size'] ); ?>"></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--image-shape"><label><?php esc_html_e( 'Image Shape', 'mobishop' ); ?></label><select name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][image_shape]"><option value="circle" <?php selected( 'circle', $settings['image_shape'] ); ?>><?php esc_html_e( 'Circle', 'mobishop' ); ?></option><option value="rounded" <?php selected( 'rounded', $settings['image_shape'] ); ?>><?php esc_html_e( 'Rounded', 'mobishop' ); ?></option><option value="square" <?php selected( 'square', $settings['image_shape'] ); ?>><?php esc_html_e( 'Square', 'mobishop' ); ?></option></select></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--label-color"><label><?php esc_html_e( 'Label Color', 'mobishop' ); ?></label><input type="color" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][label_color]" value="<?php echo esc_attr( (string) $settings['label_color'] ); ?>"></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--label-size"><label><?php esc_html_e( 'Label Size', 'mobishop' ); ?></label><input type="number" min="10" max="22" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][label_size]" value="<?php echo esc_attr( (string) $settings['label_size'] ); ?>"></div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--hide-empty">
				<label><?php esc_html_e( 'Hide Empty Categories', 'mobishop' ); ?></label>
				<label class="mobishop-page-master-toggle"><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][hide_empty]" value="1" <?php checked( true, $settings['hide_empty'] ); ?>><span class="mobishop-toggle-state"></span></label>
			</div>
			<div class="mobishop-builder-field mobishop-category-grid-image-setting mobishop-category-grid-image-setting--show-names">
				<label><?php esc_html_e( 'Show Category Names', 'mobishop' ); ?></label>
				<label class="mobishop-page-master-toggle"><input type="checkbox" name="blocks[<?php echo esc_attr( (string) $index ); ?>][settings][show_names]" value="1" <?php checked( true, $settings['show_names'] ); ?>><span class="mobishop-toggle-state"></span></label>
			</div>
		</div>
		<?php
	}
