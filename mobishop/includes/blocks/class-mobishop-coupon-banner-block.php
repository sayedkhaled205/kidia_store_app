...
if ( class_exists( 'MobiShop_Coupon_Banner_Block', false ) ) {
	return;
}

final class MobiShop_Coupon_Banner_Block extends MobiShop_Block {
	...
	<div class="mobishop-builder-field mobishop-builder-field--full mobishop-builder-field--media">
		...
		<div class="mobishop-builder-media-field">
			...
			<button type="button" class="button mobishop-select-media">
	...
	<div class="mobishop-builder-field"><label>Accent Color</label><input type="color" name="blocks[<?php echo esc_attr( $index ); ?>][settings][accent_color]" value="<?php echo esc_attr( $settings['accent_color'] ); ?>"></div>
	<div class="mobishop-builder-field"><label>Border Radius</label><input type="number" min="0" max="48" name="blocks[<?php echo esc_attr( $index ); ?>][settings][border_radius]" value="<?php echo esc_attr( (string) $settings['border_radius'] ); ?>"></div>
