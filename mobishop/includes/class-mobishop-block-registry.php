...
if ( class_exists( 'MobiShop_Block_Registry', false ) ) {
	return;
}
...
final class MobiShop_Block_Registry {
	 ...
	 *
	 * @var array<string, MobiShop_Block>
	 */
	 ...
	 *
	 * @param MobiShop_Block $block Block object.
	 *
	 * @return void
	 */
	public static function register(
		MobiShop_Block $block
	): void {
		$type = sanitize_key(
			$block->get_type()
		);
	 ...
	 *
	 * @return array<string, MobiShop_Block>
	 */
	...
	public static function schemas(): array {
		...
		if ( $block instanceof MobiShop_Block ) {
				return array_merge(
					$block->get_presentation_defaults(),
					$block->get_default_settings()
				);
