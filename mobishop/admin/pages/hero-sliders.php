...
<div class="wrap mobishop-legacy-library">
					...
					<td>
						...
						<a
							...
							href="<?php echo esc_url(
								wp_nonce_url(
									admin_url(
										'admin-post.php?action=mobishop_duplicate_hero_slider&id=' .
										$item['id']
									),
						...
						<a
							...
							href="<?php echo esc_url(
								wp_nonce_url(
									admin_url(
										'admin-post.php?action=mobishop_delete_hero_slider&id=' .
										$item['id']
									),
