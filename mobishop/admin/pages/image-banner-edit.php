...
<div class="wrap mobishop-image-banner-edit">
	...
	>
		...
		<input
			type="hidden"
			name="action"
			value="mobishop_save_image_banner"
		>
				...
				<td>
					...
					<p>
						...
						<button
							type="button"
							class="button"
							id="mobishop-select-image-banner"
						>
					...
					<img
						id="mobishop-image-banner-preview"
            ...
            (function () {
            	...
            	const button =
            		document.getElementById(
            			'mobishop-select-image-banner'
            		);

            	const input =
            		document.getElementById(
            			'mobishop-image-banner-url'
            		);

            	const preview =
            		document.getElementById(
            			'mobishop-image-banner-preview'
            		);
