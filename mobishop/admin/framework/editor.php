...
<div class="wrap mobishop-editor">

	<div class="mobishop-editor__header">

		<div>

			<a
				class="mobishop-editor__back"
	...
	<form
		...
		class="mobishop-editor-form"
		id="mobishop-editor-form"
	>
		...
		<?php wp_nonce_field( 'mobishop_library_action' ); ?>

		<div class="mobishop-editor-layout">

			<main class="mobishop-editor-main">

				<section class="mobishop-editor-card">

					<div class="mobishop-editor-card__header">
					...
					<div class="mobishop-editor-card__body">

						<div class="mobishop-editor-field">

							<label for="mobishop-editor-name">
								<?php esc_html_e(
									'Name',
									'mobishop'
								); ?>
				...
				<div class="mobishop-editor-tabs">

					<div
						class="mobishop-editor-tabs__nav"
						role="tablist"
					>
						...
						<?php foreach ( $tabs as $tab_index => $tab ) : ?>
							...
							<button
								type="button"
								class="mobishop-editor-tab-button <?php echo 0 === $tab_index ? 'is-active' : ''; ?>"
						...
						<?php endforeach; ?>
										...
										<div class="mobishop-editor-tabs__content">
                    						...
                    						<?php foreach ( $tabs as $tab_index => $tab ) : ?>
                    							...
                    							<section
                    								class="mobishop-editor-tab-panel <?php echo 0 === $tab_index ? 'is-active' : ''; ?>"
                    								data-tab-panel="<?php echo esc_attr( $tab_id ); ?>"
                    								role="tabpanel"
                    								<?php echo 0 === $tab_index ? '' : 'hidden'; ?>
                    							>

                    								<div class="mobishop-editor-card">
                    									...
                    									<div class="mobishop-editor-card__body">
                    										...
                    										<?php else : ?>
                    											...
                    											<div class="mobishop-editor-fields">
                    												...
                    												<?php foreach ( $tab_fields as $field ) : ?>
                    													...
                    													$field_id = 'mobishop-editor-field-' . $field_key;

                    													$field_class = 'mobishop-editor-field mobishop-editor-field--' . $field_type;

                    													if ( ! empty( $field['full_width'] ) ) {
                    														$field_class .= ' mobishop-editor-field--full';
                    													}
                    													?>
                    													...
                    													<div class="<?php echo esc_attr( $field_class ); ?>">
                    														...
                    														<label for="<?php echo esc_attr( $field_id ); ?>">
                    															...
                    															<?php if ( ! empty( $field['required'] ) ) : ?>
                    																<span class="mobishop-editor-required">*</span>
                    															<?php endif; ?>
                    														...
                    														<?php elseif ( 'checkbox' === $field_type ) : ?>
                    															...
                    															<label class="mobishop-editor-switch">
                    																...
                    																<span class="mobishop-editor-switch__track"></span>
                    														...
                    														<?php elseif (
                    															...
                    															<div class="mobishop-editor-media">

                    																<input
                    																	type="url"
                    																	id="<?php echo esc_attr( $field_id ); ?>"
                    																	class="mobishop-editor-media__input"
                    																	name="settings[<?php echo esc_attr( $field_key ); ?>]"
                    																	value="<?php echo esc_attr( (string) $field_value ); ?>"
                    																>

                    																<div class="mobishop-editor-media__actions">

                    																	<button
                    																		type="button"
                    																		class="button mobishop-editor-select-media"
                    																	...
                    																	<button
                    																		type="button"
                    																		class="button-link-delete mobishop-editor-remove-media"
                    																		data-target="<?php echo esc_attr( $field_id ); ?>"
                    																	>
                    																		<?php esc_html_e(
                    																			'Remove',
                    																...
                    																<img
                    																	class="mobishop-editor-media__preview"
                    						...
                    						<aside class="mobishop-editor-sidebar">
                                				...
                                				<section class="mobishop-editor-card">
                                					...
                                					<div class="mobishop-editor-card__body">
                                						...
                                						<div class="mobishop-editor-field">
                                							...
                                							<label for="mobishop-editor-status">
                                								<?php
                                								esc_html_e(
                                									'Status',
                                									'mobishop'
                                						...
                                						<div class="mobishop-editor-actions">
