(function () {
	...
	function bootLicensePreview() {
		if (!document.body.classList.contains("mobishop-cms-license-preview")) {
			return;
		}

		var config = window.mobishopLicensePreview || {};
		var shell = document.querySelector("[data-mobishop-cms-shell]");
		var notice = document.createElement("div");
		notice.className = "mobishop-license-preview-notice";
