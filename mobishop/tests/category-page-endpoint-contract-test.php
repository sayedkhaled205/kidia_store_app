...
require dirname( __DIR__ ) . '/includes/class-mobishop-category-page-store.php';
require dirname( __DIR__ ) . '/api/class-category-page-endpoint.php';
$endpoint = new MobiShop_Category_Page_Endpoint();
$endpoint->register_routes();
assert( isset( $GLOBALS['routes']['mobishop/v1/category-page'] ) );
