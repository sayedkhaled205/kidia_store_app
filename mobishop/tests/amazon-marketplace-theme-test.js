...
const source = fs.readFileSync(path.join(root, 'includes/class-mobishop-setup-wizard.php'), 'utf8');
const plugin = fs.readFileSync(path.join(root, 'mobishop.php'), 'utf8');
