...
final class MobiShop_Category_Page_Endpoint {
	...
	public function preview_categories( WP_REST_Request $request ): WP_REST_Response {
		...
		$response = new WP_REST_Response( MobiShop_Category_Page_Store::sanitize_general( is_array( $general ) ? $general : array() ), 200 );
	...
	public function get_categories( WP_REST_Request $request ): WP_REST_Response {
		...
		$page_settings = ( new MobiShop_Category_Page_Store() )->get_settings();
	...
	private function format_term( WP_Term $term, array $setting, array $general ): array {
		...
		return array(
			...
			'presentation' => array(
				...
				'card_width_percent' => $general['card_width_percent'],
